---
description: Create an XQL query from a Query Builder template in Cortex XSIAM.
---
...
* [Query Builder templates](../../../../detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates)
* [Get started with Query Builder templates](../../../../detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates/get-started-with-query-builder-templates)
* [Considerations for using Query Builder templates](../../../../detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates/considerations-for-using-query-builder-templates)
...
2.  In the Query Builder, select the template that you want to use.
    ...
    If you want to use the Free Text Search template, see [Run a free text query](../../../../detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates/run-a-free-text-query).
...
For more information about using the filtering fields, operators, and including **Empty values**, see [Considerations for using Query Builder templates](../../../../detect-investigate-and-respond-to-threats/investigation-and-response/build-xql-queries/query-builder-templates/considerations-for-using-query-builder-templates).
