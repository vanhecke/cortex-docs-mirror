...
7.  Validate the schema.\
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p><strong>Note</strong>:</p><p>We highly recommend that you don't change the auto-detected schema. However, if the auto-detected schema is incorrect, you can add, edit, or delete fields.</p></div>
...
1.  Create a new registration in Azure Blob Storage to be used by Federated Search.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>Copy the Directory (tenant) ID, the Application (client) ID, and the Object ID. You will use these in the connection step.</p></div>
...
4. Assign a role to the application.
   ...
   2. Select the container and, on the left menu, click Access Control (IAM).
...
8.  Validate the schema.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p>We highly recommend that you don't change the auto-detected schema. However, you can add, edit, or delete fields.</p></div>
