---
description: Set an alias to identify an endpoint more clearly in Cortex XSIAM.
---
...
6. Use the **Quick Launcher** to search for endpoints by alias across Cortex XSIAM.
