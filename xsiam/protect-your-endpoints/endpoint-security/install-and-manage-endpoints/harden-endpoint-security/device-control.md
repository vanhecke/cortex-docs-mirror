---
description: >-
  Configure Cortex XSIAM device control policies for USB, Bluetooth, printers,
  and peripheral access on endpoints.
---
...
Device Configuration and Device Exceptions profiles are configured for each operating system. After you configure a device control profile, [apply device control profiles to your endpoints](#apply-device-control-profiles-to-your-endpoints).
