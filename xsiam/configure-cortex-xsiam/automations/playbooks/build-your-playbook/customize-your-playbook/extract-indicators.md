---
description: >-
  Extract and enrich threat indicators from Cortex XSIAM issue fields and
  playbook task outputs.
---
...
2. Click <img src="data:image/png;base64," alt="three-dots.png" data-size="line"> and select either **Duplicate** (create a copy of the playbook to edit) or **Edit Playbook** (detach the playbook).
