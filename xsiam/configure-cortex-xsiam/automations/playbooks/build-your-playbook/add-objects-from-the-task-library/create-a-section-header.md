---
description: Add section headers to organize tasks in Cortex XSIAM playbooks.
---
...
4. In the **Details** tab, configure the following.
   ...
   * **Task description (Markdown supported)**: Provide a description of what this task does. In the Playbooks page, click <img src="data:image/png;base64," alt="playbook-info-icon.png" data-size="line"> on the section header to display the description.
