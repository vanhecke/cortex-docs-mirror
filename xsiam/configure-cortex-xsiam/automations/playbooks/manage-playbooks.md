...
The **Playbooks** page is organized to help you easily access and utilize playbooks specific to your use cases. It contains two main sections: key playbook details at the top and a table listing all the playbooks in your Org repository at the bottom.

### Monitor Cortex XSIAM playbook status

Playbook statuses track the progress of automation tasks and identify any issues or delays. If needed, you can then take corrective actions to ensure smooth workflow execution and operational efficiency. The status includes how many playbooks:
...
### Manage playbooks in the Cortex XSIAM Org repository
...
### Find and adopt Cortex XSIAM playbooks from the Playbook Catalog
...
* **Name**: Limits the search to the playbook title.
