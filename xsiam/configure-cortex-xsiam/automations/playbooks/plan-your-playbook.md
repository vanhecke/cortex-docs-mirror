...
Review the following workflow for a phishing use case. Also, review the playbooks in the [Phishing content pack](https://cortex.marketplace.pan.dev/marketplace/details/Phishing/) to see how they work.
