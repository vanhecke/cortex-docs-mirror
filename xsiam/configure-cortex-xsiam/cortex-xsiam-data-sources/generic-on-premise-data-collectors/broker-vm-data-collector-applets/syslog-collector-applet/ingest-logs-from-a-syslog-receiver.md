...
Cortex XSIAM can receive Syslog from a variety of supported vendors (see [External data ingestion vendor support](https://app.gitbook.com/s/FOhYBYLdbwpnbJgr6uaX/cortex-xdr-3.x-documentation/data-management/data-ingestion/external-data-ingestion-vendor-support)). In addition, Cortex XSIAM can receive Syslog from additional vendors that use CEF, LEEF, CISCO, CORELIGHT, or RAW formatted over Syslog.External data ingestion vendor support
