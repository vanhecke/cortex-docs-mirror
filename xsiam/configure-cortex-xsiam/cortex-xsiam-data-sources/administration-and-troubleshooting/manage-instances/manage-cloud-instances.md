...
6.  You can perform the following actions on each cloud instance:
    ...
    | Edit configuration    | <p>In the row for the cloud instance, right-click and select <strong>Configuration</strong>. Alternatively, in the details pane, click the edit button. Follow the onboarding wizard to edit the cloud instance's settings.</p><p>You must execute the updated template in the CSP environment for the configuration changes to be applied.</p> |
