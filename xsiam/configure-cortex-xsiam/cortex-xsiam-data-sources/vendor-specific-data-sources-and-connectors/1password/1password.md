...
* [OnePassword](https://xsoar.pan.dev/docs/reference/integrations/one-password): Fetch events about actions performed by 1Password users within a specific account, access and modifications to items in shared vaults, and user sign-in attempts.
