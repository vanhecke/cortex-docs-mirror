...
* [ZeroNetworksSegmentEventCollector](https://xsoar.pan.dev/docs/reference/integrations/zero-networks-segment-event-collector): Integrates with Zero Networks Segment API to fetch and process audit and network events.
