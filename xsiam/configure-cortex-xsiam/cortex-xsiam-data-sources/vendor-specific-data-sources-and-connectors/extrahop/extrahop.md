...
* [ExtrahopRevealXEventCollector](https://xsoar.pan.dev/docs/reference/integrations/extrahop-reveal-x-event-collector): ExtraHop Reveal(x) is a network detection and response solution that provides complete visibility of network communications at enterprise scale, real-time threat detections backed by machine learning, and guided investigation workflows that simplify response.
