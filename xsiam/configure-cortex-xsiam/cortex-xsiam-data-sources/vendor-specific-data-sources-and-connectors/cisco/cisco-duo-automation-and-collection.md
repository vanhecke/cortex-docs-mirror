...
* [DUO Admin](https://xsoar.pan.dev/docs/reference/integrations/duo-admin): This sub-capability is available with any active Cortex XSIAM or Cortex AgentiX license.
* [Duo Event Collector](https://xsoar.pan.dev/docs/reference/integrations/duo-event-collector): Collects Auth and Audit events for Duo using the API. This sub-capability is available with any active Cortex XSIAM license.
