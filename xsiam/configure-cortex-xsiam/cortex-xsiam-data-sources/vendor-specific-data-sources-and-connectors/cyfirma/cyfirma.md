...
* [DecyfirEventCollector](https://xsoar.pan.dev/docs/reference/integrations/decyfir-event-collector): Collects event logs from DeCYFIR for ingestion into Cortex XSIAM.
