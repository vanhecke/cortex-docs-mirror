...
| Link to standard data source instructions                     | [Set up an HTTP log collector to receive logs](http-log-collector/set-up-an-http-log-collector-to-receive-logs)            |
