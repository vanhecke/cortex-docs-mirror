---
description: Use Fastly data with Cortex XSIAM.
---
...
* [Fastly Feed](https://xsoar.pan.dev/docs/reference/integrations/fastly-feed)
* [Signal Sciences WAF](https://xsoar.pan.dev/docs/reference/integrations/signal-sciences-waf)
