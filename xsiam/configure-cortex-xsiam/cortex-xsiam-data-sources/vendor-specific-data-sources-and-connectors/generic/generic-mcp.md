...
* [Generic MCP](https://xsoar.pan.dev/docs/reference/integrations/generic-mcp): Use this integration to connect to an MCP server and automatically discover its available tools.
