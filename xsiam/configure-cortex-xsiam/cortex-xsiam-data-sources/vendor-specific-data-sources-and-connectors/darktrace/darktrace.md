---
description: Use Darktrace data with Cortex XSIAM.
---
...
* [Darktrace Event Collector](https://xsoar.pan.dev/docs/reference/integrations/darktrace-event-collector): Use this integration to fetch model breaches from Darktrace as events in XSIAM.
