---
description: Use Envoy data with Cortex XSIAM.
---
...
* [Envoy IAM](https://xsoar.pan.dev/docs/reference/integrations/envoy-iam): Integrate with Envoy Identity Access Management services to execute CRUD operations to employee lifecycle processes.
