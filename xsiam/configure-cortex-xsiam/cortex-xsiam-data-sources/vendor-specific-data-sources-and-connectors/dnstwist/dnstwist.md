---
description: Use dnstwist data with Cortex XSIAM.
---
...
* [dnstwist](https://xsoar.pan.dev/docs/reference/integrations/dnstwist): Use the DNSTwist integration to detect typosquatting, phishing, and corporate espionage.
