...
* [SolarWinds](https://xsoar.pan.dev/docs/reference/integrations/solar-winds): The SolarWinds integration interacts with the SWIS API to allow you to fetch alerts and events. It also provides commands to retrieve lists of alerts and events.
