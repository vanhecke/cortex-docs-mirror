...
* [Absolute](https://xsoar.pan.dev/docs/reference/integrations/absolute): Absolute is an adaptive endpoint security solution that delivers device security, data security, and asset management of endpoints.
