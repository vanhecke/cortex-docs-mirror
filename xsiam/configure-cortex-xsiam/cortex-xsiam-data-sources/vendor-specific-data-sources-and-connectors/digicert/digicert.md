...
* [VercaraUltraDNS](https://xsoar.pan.dev/docs/reference/integrations/vercara-ultra-dns): Vercara UltraDNS integration for Cortex. Leverage UltraDNS's cloud-based DNS event and configuration data for security automation and real-time threat detection in Cortex.
