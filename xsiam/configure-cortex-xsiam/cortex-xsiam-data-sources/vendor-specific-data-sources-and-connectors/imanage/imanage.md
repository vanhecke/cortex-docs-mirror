...
* [iManageThreatManager](https://xsoar.pan.dev/docs/reference/integrations/i-manage-threat-manager): iManage Threat Manager protects privileged information against internal and external threat actors using machine learning and user behavior analytics.
