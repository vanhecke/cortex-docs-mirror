...
* [Jamf Protect Event Collector](https://xsoar.pan.dev/docs/reference/integrations/jamf-protect-event-collector): Use this integration to fetch audit logs events, alerts events and computer assets from Jamf Protect to Cortex XSIAM. This sub-capability is available with any active Cortex XSIAM license.
* [jamf v2](https://xsoar.pan.dev/docs/reference/integrations/jamf-v2): Enterprise Mobility Management (EMM) for Apple devices (Mac, iPhone, Apple TV, iPad). Can be used to control various configurations via different policies, install and uninstall applications, lock devices, smart groups searches, and more. This sub-capability is available with any active Cortex XSIAM or Cortex AgentiX license.
