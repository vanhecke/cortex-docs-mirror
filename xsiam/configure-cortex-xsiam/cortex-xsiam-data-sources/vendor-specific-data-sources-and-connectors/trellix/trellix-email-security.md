...
* [FireEye Email Security](https://xsoar.pan.dev/docs/reference/integrations/fire-eye-email-security):
* [FireEyeNX](https://xsoar.pan.dev/docs/reference/integrations/fire-eye-nx): FireEye Network Security is an effective cyber threat protection solution that helps organizations minimize the risk of costly breaches by accurately detecting and immediately stopping advanced, targeted, and other evasive attacks hiding in internet traffic.
