...
* [ArcSight ESM v2](https://xsoar.pan.dev/docs/reference/integrations/arc-sight-esm-v2): ArcSight ESM SIEM by Micro Focus (Formerly HPE Software).
* [ArcSight Logger](https://xsoar.pan.dev/docs/reference/integrations/arc-sight-logger): ArcSight events logger.
