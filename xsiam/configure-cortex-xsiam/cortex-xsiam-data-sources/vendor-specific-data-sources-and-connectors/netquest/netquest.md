---
description: Use NetQuest data with Cortex XSIAM.
---
...
* [NetQuestOMX](https://xsoar.pan.dev/docs/reference/integrations/net-quest-omx): NetQuest's products are high-capacity service nodes that help security teams access and analyze network traffic. Powerful packet and flow processing features assist security tools in detecting and mitigating security threats as cost effectively as possible.
