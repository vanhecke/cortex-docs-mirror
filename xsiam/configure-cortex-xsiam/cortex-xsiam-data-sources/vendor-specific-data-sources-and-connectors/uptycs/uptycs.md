...
* [UptycsEventCollector](https://xsoar.pan.dev/docs/reference/integrations/uptycs-event-collector): Uptycs is a cloud-native security analytics platform that provides visibility, threat detection, and compliance across endpoints and cloud workloads.
