...
* [IBM Storage Scale](https://xsoar.pan.dev/docs/reference/integrations/ibm-storage-scale): Collects Command Line Interface (CLI) audit log records from IBM Storage Scale.
