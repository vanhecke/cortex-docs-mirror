---
description: Use SMB data for Cortex XSIAM file and directory management.
---
...
* [Server Message Block (SMB) v2](https://xsoar.pan.dev/docs/reference/integrations/server-message-block-smb-v2)
