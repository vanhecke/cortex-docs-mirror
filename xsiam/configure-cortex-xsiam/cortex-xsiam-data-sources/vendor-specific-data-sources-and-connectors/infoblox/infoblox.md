...
* [Infoblox BloxOne Threat Defense Event Collector](https://xsoar.pan.dev/docs/reference/integrations/infoblox-blox-one-threat-defense-event-collector): BloxOne Threat Defense is a hybrid cybersecurity solution that leverages DNS as the first line of defense to detect and block cyber threats.
