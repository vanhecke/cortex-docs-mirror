...
* [Bitwarden Password Manager](https://xsoar.pan.dev/docs/reference/integrations/bitwarden-password-manager): This integration collects event logs from Bitwarden Password Manager to Cortex XSIAM.
