...
| Audit log collection                                                           | `cortex-logs-ingestion-access-*`  | Cortex XSIAM log collector (via Google OIDC: accounts.google.com with a specific audience and Google service-account ID) |
