...
* [PaloAltoNetworks\_PrismaCloudCompute](https://xsoar.pan.dev/docs/reference/integrations/palo-alto-networks-prisma-cloud-compute): Use the Prisma Cloud Compute integration to fetch incidents from your Prisma Cloud Compute environment.
