...
When your contribution is approved, it is uploaded to **Marketplace** where other Cortex XSIAM users can view, download, and rate it. We encourage you to learn more about the [contribution process](https://xsoar.pan.dev/docs/contributing/contributing).
