...
2.  Select **Add**. The **Add Contact** dialog opens with the **Contact Details** section and required fields.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><h3>Note</h3><p>All fields are mandatory.</p></div>

    | Field        | Description                                       |
    | ------------ | ------------------------------------------------- |
    | Contact name | Enter first and last name (both are required).    |
    | Role         | Add the role as defined by the organization.      |
    | Email        | Add email address.                                |
    | Phone number | Add contact phone number, including country code. |
3. Click **Add** to save the contact details.
4. Right-click on the contact to edit, delete, or copy.
