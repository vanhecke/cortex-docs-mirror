...
3. In the Cluster Configurations window, you can edit the parameters based on your previous settings. For more information on each of these settings, see [Configure High Availability Cluster](../configure-high-availability-cluster).
