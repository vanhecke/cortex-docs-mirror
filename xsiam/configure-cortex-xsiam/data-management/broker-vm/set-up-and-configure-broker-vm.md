...
| **`br-__.xdr.<region>.paloaltonetworks.com`** HTTPS over TCP port 443                                                                                                                 | Broker Service server depending on the region of your deployment, such as **`us`** or **`eu`**.                                                                                    |
...
| **`br-__.xdr.federal.paloaltonetworks.com`** HTTPS over TCP port 443                                                                                                                  | Broker Service server for Federal (US Government) deployment.                                                                                                                      |
