...
For more information on activating the Broker VM applets, see [Generic on-premise data collectors](../../../cortex-xsiam-data-sources/generic-on-premise-data-collectors).
