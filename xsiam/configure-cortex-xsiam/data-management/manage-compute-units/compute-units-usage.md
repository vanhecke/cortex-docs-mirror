---
description: >-
  View compute unit consumption, set daily limits, and investigate XQL API query
  usage in Cortex XSIAM.
---

# Manage compute unit usage
...
{% hint style="warning" %}
Compute unit consumption currently applies only to XQL queries. Agentic and LLM information is shown only for informational purposes and does not consume compute units.
{% endhint %}
...
### View and manage compute unit usage in Cortex XSIAM
...
#### Monitor compute unit usage widgets

The following widgets present information about your compute unit consumption and enable you to manage the daily limit.

{% hint style="info" %}
Widgets include data for agents and LLM usage, but agents and LLM usage do not consume compute units at this time. Data is provided only for informational purposes.
{% endhint %}
...
#### View compute unit usage details
...
* **Timestamp:** Date and time of execution. For Notebooks and BQ queries, this is the date and time the query is charged.
...
### Investigate XQL API query results
