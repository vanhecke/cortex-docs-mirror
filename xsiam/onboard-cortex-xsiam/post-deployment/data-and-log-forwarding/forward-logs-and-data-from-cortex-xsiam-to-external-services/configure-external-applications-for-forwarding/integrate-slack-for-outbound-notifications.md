...
After you integrate with your Slack workspace, configure your forwarding settings. For more information, see [Configure notification forwarding](../configure-notification-forwarding). To send notifications about failed reports to Slack, see Run or schedule reports.
