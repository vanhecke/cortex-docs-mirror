...
For extra automated actions, use the playbooks, scripts, and commands in the Cortex XSIAM automation engine. For more information, see [Automation in Cortex XSIAM](../../configure-cortex-xsiam/automations/automation-in-cortex-xsiam).
{% endhint %}
