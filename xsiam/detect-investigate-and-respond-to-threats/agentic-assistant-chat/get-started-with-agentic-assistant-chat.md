...
The Cortex Agentic Assistant is currently available in limited regions. For more information, see [Agentic AI in Cortex XSIAM](../../learn-about-cortex-xsiam/agentic-ai-in-cortex-xsiam). If your tenant is not within one of those regions, you have access to the [Cortex Assistant](../investigation-and-response/cortex-assistant).

To enable the Cortex Agentic Assistant, go to **Settings** → **Configurations** → **General** → **Server Settings** → **AI Configuration**.
{% endhint %}

To access the chat, you must have the correct permissions. For more information, see [Agentic Assistant role-based access control](../../configure-cortex-xsiam/configure-the-cortex-agentic-assistant-1/agentic-assistant-role-based-access-control).
