...
{% hint style="info" %}
**Note:** Global filters are available for dashboards that include custom XQL widgets with defined parameters. For more information, see [Create XQL widgets](advanced-configuration/create-custom-widgets/create-xql-widgets).
{% endhint %}
...
{% hint style="info" %}
**Note:** Drilldowns are available for dashboards that include custom XQL widgets. For more information, see [Create XQL widgets](advanced-configuration/create-custom-widgets/create-xql-widgets).
{% endhint %}
