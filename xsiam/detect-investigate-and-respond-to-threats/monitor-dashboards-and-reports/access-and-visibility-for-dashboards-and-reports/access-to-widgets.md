...
* **Duplicating dashboards and templates:** If you duplicate a dashboard or template containing **Restricted** widgets, you can view the widgets but cannot edit them. To make changes to a Restricted widget, simply duplicate it to create an editable copy. For more information see [Duplicate dashboards and reports](../manage-dashboards-and-reports/duplicate-dashboards-and-reports).
