...
Once created, you can see all of your widgets and the widgets that you have permission to access in the **Widget Library**. For more information about access and visibility to **Restricted** and **Public** widgets, see [Access to widgets](../access-and-visibility-for-dashboards-and-reports/access-to-widgets).
