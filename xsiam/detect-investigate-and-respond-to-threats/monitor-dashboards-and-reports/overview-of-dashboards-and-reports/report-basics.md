...
You can configure your report templates to run on a schedule and distribute to specific emails or slack channels, or you can run them instantly as a single instance. For more information, see [Reports](../manage-dashboards-and-reports/reports).
