...
* **Create new widgets:** Build new widgets using XQL queries, scripts, or by using AI. For more information, see [Create custom widgets](../advanced-configuration/create-custom-widgets).
