...
The Cortex Agentic Assistant is only available after it is enabled and for tenants in certain regions. For more information, see [Cortex Agentic Assistant](../../../../learn-about-cortex-xsiam/agentic-ai-in-cortex-xsiam).
{% endhint %}
