...
You can manage all starring configurations under **Case & Issues → Case Configuration** → **Starred Issues**. For more information see [Create a starring configuration](../../../configure-cortex-xsiam/customize-cases-and-issues/create-a-starring-configuration).
