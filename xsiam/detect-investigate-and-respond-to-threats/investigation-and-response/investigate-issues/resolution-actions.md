...
While actions are issue-specific, they sync automatically to the Resolution Center for the linked case. You can run actions in the **Resolution** tab for a specific issue, or use the case **Resolution Center** to apply resolutions to multiple issues. For more information, see [Resolution Center](../analyze-and-resolve-cases/resolve-the-case/resolution-center).
