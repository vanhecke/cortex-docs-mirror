...
* **Graph issues:** Triggered by Graph Rules. They visualize cross-domain posture findings, asset dependencies, and custom graph queries. For more information, see [Create a graph rules](../../../../cloud-security/cloud-security-rules-and-policies/create-and-manage-cloud-security-rules/create-a-graph-rule).
