...
For a full list and description of each of the integrations in the Cortex Response and Remediation content pack, see the _Content_ tab in [Cortex Response And Remediation](https://cortex.marketplace.pan.dev/marketplace/details/CortexResponseAndRemediation/).
