...
* [Agent-based protection](configure-api-security-from-end-to-end/agent-based-protection)

**Third-party integrations**

Easily configure the settings in both Cortex XSIAM and your cloud service to retrieve and collect API data for further analysis by Cortex's comprehensive [API security](gain-visibility-and-assess-risk-of-api-endpoints) capabilities, which provide a transparent view of API traffic, helping to identify potential security threats.
